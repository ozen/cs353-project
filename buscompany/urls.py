...
urlpatterns = [
    ...
    url(r'^manager/addTerminal/((?P<pk>\d+)/)?$', views.manager.addTerminal),
    url(r'^manager/addSalesOffice/((?P<pk>\d+)/)?$', views.manager.addSalesOffice),
    url(r'^manager/addSalesperson/((?P<pk>\d+)/)?$', views.manager.addSalesperson),
    url(r'^manager/addTerminalAgent/((?P<pk>\d+)/)?$', views.manager.addTerminalAgent),
    ...
    url(r'^manager/listTerminal$', views.manager.listTerminal),
    url(r'^manager/listSalesOffice$', views.manager.listSalesOffice),
    url(r'^manager/listSalesperson$', views.manager.listSalesperson),
    url(r'^manager/listTerminalAgent$', views.manager.listTerminalAgent),
    ...
    url(r'^manager/deleteTerminal/(?P<pk>\d+)/$', views.manager.deleteTerminal),
    url(r'^manager/deleteSalesOffice/(?P<pk>\d+)/$', views.manager.deleteSalesOffice),
    url(r'^manager/deleteSalesperson/(?P<pk>\d+)/$', views.manager.deleteSalesperson),
    url(r'^manager/deleteTerminalAgent/(?P<pk>\d+)/$', views.manager.deleteTerminalAgent),
